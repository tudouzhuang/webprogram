...
public class QualityReportDTO {
    ...
    public static class GlobalSummary {
        ...
        private Double onePassRate;       // 一次通过率（旧指标留空兼容）
        private Double firstComplianceRate; // 🔥【核心新增】首次符合率
    ...
    public static class StatEntry {
        ...
        private Double firstComplianceRate; // 🔥【核心新增】该维度下的首次符合率
        private Integer firstRoundNgCount;  // 🔥【核心新增】该维度下的首轮整改项数
