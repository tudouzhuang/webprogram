...
/**
 * 【专用控制器】: 负责处理所有与“设计过程记录表” (ProcessRecord) 资源相关的API请求。
...
public class ProcessRecordController {
    ...
    /**
     * API: 查询指定过程记录的审核表文件信息。
     * 路径: GET /api/process-records/{recordId}/review-sheet-info
     */
    ...
    /**
     * API: 保存审核结果文件
     * 路径: POST /api/process-records/{recordId}/save-review-sheet
     */
   ...
   public ResponseEntity<String> saveReviewSheet(
    ...
    /**
     * API: 转交任务
     * 路径: POST /api/process-records/{recordId}/reassign
     */
    ...
    /**
     * API: 打回修改
     * 路径: POST /api/process-records/{recordId}/request-changes
     */
    ...
    /**
     * API: 设计员重新提交审核
     * 路径: POST /api/process-records/{recordId}/resubmit
     */
