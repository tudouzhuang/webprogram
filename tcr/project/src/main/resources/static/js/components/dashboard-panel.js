Vue.component('dashboard-panel', {
                ...
                <div class="home-tab">
                    ...
                    <div class="tab-content tab-content-basic">
                        <div class="tab-pane fade show active" id="overview" role="tabpanel"
                                    ...
                                    <div class="statistics-details d-flex align-items-center justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-success d-flex"><i
                                                    class="mdi mdi-menu-up"></i><span>+0.1%</span>
                                            </p>
                                        </div>
                                        <div>
                                            ...
                                            <div class="card card-rounded">
                                                <div class="card-body">
                                                    <div class="d-sm-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h4 class="card-title card-title-dash">审批工作量折线表</h4>
                                                            <h5 class="card-subtitle card-subtitle-dash">直观读出您每周的审批数量</h5>
                                                        </div>
                            ...
                            <div class="row"><div class="col-lg-8 d-flex flex-column">
    `,
    data() {
        return {
    ...
    mounted() {
        console.log('Dashboard Panel 组件已挂载');
    }
});